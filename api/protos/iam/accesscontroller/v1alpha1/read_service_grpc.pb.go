...
func (c *readServiceClient) ListRelationTuples(ctx context.Context, in *ListRelationTuplesRequest, opts ...grpc.CallOption) (*ListRelationTuplesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/iam.accesscontroller.v1alpha1.ReadService/ListRelationTuples", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ReadService_ListRelationTuples_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/iam.accesscontroller.v1alpha1.ReadService/ListRelationTuples",
	}
...
var ReadService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "iam.accesscontroller.v1alpha1.ReadService",
	...
	Metadata: "iam/accesscontroller/v1alpha1/read_service.proto",
}
